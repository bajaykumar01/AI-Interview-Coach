    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen font-sans selection:bg-indigo-500/30 selection:text-indigo-200">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-lg shadow-indigo-600/20 transition-all hover:scale-105 active:scale-95"
            >
              Register
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="bg-slate-900/40 border border-slate-850 p-8 rounded-2xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold text-white mb-3">1. Resume Analysis</h3>
            ...
            <motion.div variants={itemVariants} className="bg-slate-900/40 border border-slate-850 p-8 rounded-2xl backdrop-blur-sm">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Choose between Resume-based mode (High difficulty) or select specific topics like Java, SQL, React, ML, CN, OS, OOPS, and DBMS manually.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-slate-900/40 border border-slate-850 p-8 rounded-2xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold text-white mb-3">3. AI Evaluation</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="glass-card p-6 rounded-2xl">
            ...
            <h4 className="text-lg font-bold text-white mb-2">Resume Parsing</h4>
      ...
      <section className="py-20 bg-slate-900/30 border-y border-slate-900 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-around gap-12 text-center">
          <div>
            <div className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 mb-2">1,000+</div>
            <div className="text-slate-400 text-sm uppercase tracking-widest font-semibold">Questions Answered</div>
          </div>
          ...
          <div>
            ...
            <div className="text-slate-400 text-sm uppercase tracking-widest font-semibold">Supported Techs</div>
          </div>
          <div className="h-px w-12 md:h-12 md:w-px bg-slate-800" />
          <div>
            <div className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 mb-2">100%</div>
            <div className="text-slate-400 text-sm uppercase tracking-widest font-semibold">AI Powered</div>
          </div>
          <div className="h-px w-12 md:h-12 md:w-px bg-slate-800" />
          <div>
            <div className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 mb-2">MySQL</div>
            <div className="text-slate-400 text-sm uppercase tracking-widest font-semibold">Structured Storage</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center max-w-4xl mx-auto">
        ...
        <button 
          onClick={() => navigate("/register")}
          className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-indigo-600/25 transition-transform hover:-translate-y-0.5"
        >
